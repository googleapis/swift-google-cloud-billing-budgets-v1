...
extension Clients {
  ...
  class BudgetServiceTransport: BudgetServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://billingbudgets.googleapis.com")
    }
    ...
    public func createBudget(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBillingBudgetsV1.Budget.self, from: data)
    }
    ...
    public func listBudgets(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBillingBudgetsV1.ListBudgetsResponse.self, from: data)
    }
